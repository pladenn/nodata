...
INSERT INTO public.action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect) VALUES ('fa35b5dd-6e29-6474-3f10-07b684c06a62', 'system-action-links', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', e'select 
  l.title,
  ...
  case when l.is_action_target = true then \'action\' else \'row\' end linked_to,
  l.via_parameters,
  l.id,
  l."order"
from action_link l
...
where ((:parent_action_id::uuid is not null and parent_action_id = :parent_action_id) or (:parent_action_id::uuid is null and parent_action_id is not null) or (:parent_action_id::uuid is not null and parent_action_id is null and :global = true))
and (child_action_id = :child_action_id or :child_action_id::uuid is null)
and (l.id = :id or :id::uuid is null)
order by l.parent_action_id, l.is_action_target, l."order"', null, 'SQL_DQL', 'Links', null, 'Links', null);
...
INSERT INTO public.action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect) VALUES ('9a24510e-55b2-bca8-cb1f-27752b2c5a95', 'ttt', 'ee75d98d-365e-23a0-74a1-8ba5a56eb552', '?param1={param1}&parma2={param2}', null, 'HTTP_GET', 'ttt', null, null, null);
