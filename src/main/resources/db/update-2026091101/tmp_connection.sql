...
INSERT INTO public.tmp_connection (id, description, type, url, login, password, code) VALUES ('20a9693e-d032-f7f1-d197-6f11ffab6ba7', 'Any sql connection', 'SQL', '{credentials.url}', '{credentials.login}', '{credentials.password}', 'any-sql-connection');
