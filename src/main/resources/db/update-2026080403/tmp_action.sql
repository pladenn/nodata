...
END $$', NULL, 'SQL_BLOCK', 'Create action', NULL, 'Create action', '/content/system/system-actions?code={request-parameters.code}', false, 'Create action');
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect, post_request, name) VALUES ('3d6fcc69-8b4f-c653-e23a-231452862ad7', 'system-create-action-link-mapping', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'insert into action_link_mapping
...
ON CONFLICT ON CONSTRAINT unique_action_link_id_parameter_id
    DO update set mapping = EXCLUDED.mapping, default_value = :default_value', NULL, 'SQL_DML', 'Map link parameter', NULL, 'Map link parameter', '{request-parameters._original_url}', false, 'Map link parameter');
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect, post_request, name) VALUES ('ba7829af-09a9-e951-90fa-d04171739f46', 'system-delete-action', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'DO $$declare
    action_id uuid;
BEGIN
...
END $$', NULL, 'SQL_BLOCK', 'Delete action', NULL, 'Delete action', '{request-parameters._original_url}', false, 'Delete action');
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect, post_request, name) VALUES ('081f536b-6882-46b1-bbf2-1fd976e4a3f5', 'system-connections', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'select * from connection con
...
order by p."group", p.property, p.value', NULL, 'SQL', '{parameters.description}', NULL, '{parameters.description}', NULL, false, '{parameters.description}');
...
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect, post_request, name) VALUES ('924039ab-a63f-2ef3-2578-616eefe35c1b', 'system-environments-dictionary', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'with base_path as
         (select value bp
          from property p
...
order by 1', NULL, 'SQL', 'Environments', NULL, 'Environments', NULL, false, 'Environments');
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect, post_request, name) VALUES ('b0078e88-3425-ea62-606f-774f538bbcd9', 'system-delete-connection', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'DO $$declare
    connection_id uuid;
BEGIN
...
END $$', NULL, 'SQL_BLOCK', 'Delete connection', NULL, 'Delete connection', '{request-parameters._original_url}', false, 'Delete connection');
...
from flds field', NULL, 'SQL', 'View', NULL, 'View', NULL, false, 'View');
...
VALUES (gen_random_uuid(),
        ...
        :order,
        :default_value
)', NULL, 'SQL_DML', 'Create parameter for the action "{PARAMETERS.action_title}"({PARAMETERS.action_code})', NULL, 'Create parameter for the action "{PARAMETERS.action_title}"({PARAMETERS.action_code})', '{request-parameters._original_url}', true, 'Create parameter for the action "{PARAMETERS.action_title}"({PARAMETERS.action_code})');
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect, post_request, name) VALUES ('b47c0f1f-5569-083f-ca7a-14d9a6736e4d', 'system-update-action-link', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'update action_link l set title = :title, 
via_parameters = :via_parameters::boolean,
category = :group::varchar,
"order" = :order,
variable = :variable,
mapping = :mapping
where id = :id', NULL, 'SQL_DML', 'Update link', NULL, 'Update link', '{request-parameters._original_url}', false, 'Update link');
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect, post_request, name) VALUES ('ff53d3e8-780f-43f1-ae7b-8a1d5037e142', 'system-update-dictionary', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'update properties
set value = :dictionary_name::varchar,
    key = :dictionary_code::varchar
where id = :dictionary_id::uuid', NULL, 'SQL_DML', 'Edit dictionary', NULL, 'Edit dictionary', '{request-parameters._original_url}', true, 'Edit dictionary');
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect, post_request, name) VALUES ('5d38171a-bd9b-4be9-9c38-5121ae471e69', 'system-create-dictionary', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'insert into properties
select
    gen_random_uuid(),
    (select id from properties where parent_id is null and key = ''dictionaries''),
    :dictionary_code::varchar,
    :dictionary_name::varchar', NULL, 'SQL_DML', 'Create dictionary', NULL, 'Create dictionary', '{request-parameters._original_url}', true, 'Create dictionary');
...
"order" = :order
where id = :id', NULL, 'SQL_DML', 'Update parameter for the action "{action_name}"({action_code})', NULL, 'Update parameter for the action "{action_name}"({action_code})', '{request-parameters._original_url}', false, 'Update parameter for the action "{action_name}"({action_code})');
...
ON CONFLICT(id)
    DO UPDATE SET
      ...
      name = :name,
      path = :path,
      "order" = :order', NULL, 'SQL_DML', '{create-update} column for the action "{action_title}"({action_code})', NULL, '{create-update} column for the action "{action_title}"({action_code})', '{request-parameters._original_url}', false, '{create-update} column for the action "{action_title}"({action_code})');
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect, post_request, name) VALUES ('27a15286-7c9e-fb12-b406-bc42ab29510c', 'system-create-property', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'INSERT INTO public.property (id, "group", property, value, category_id)
VALUES (
...
)', NULL, 'SQL_DML', 'Create property', NULL, 'Create property', '{request-parameters._original_url}', false, 'Create property');
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect, post_request, name) VALUES ('4d45abd8-7edc-5b5b-b08f-1a0c151a722a', 'system-delete-action-link-mapping', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'delete from action_link_mapping 
where id = :id or action_link_id = :action_link_id', NULL, 'SQL_DML', 'Unmap link parameter', NULL, 'Unmap link parameter', '{request-parameters._original_url}', false, 'Unmap link parameter');
...
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect, post_request, name) VALUES ('a45d744d-339c-08f2-6993-8841e28f78fd', 'insert_action', 'b16c7ed6-3beb-495c-b38e-337f9adec0a1', '/content/system/system-welcome/data', '{
  "code" : "${code}",
  "query" : "${query}",
  "content" : "${content}",
  "http_method" : "${http_method}",
  "connectionId" : "d48b9a97-e13c-4961-9eff-d76f39abdffb"}', 'HTTP_GET', 'Just for example', NULL, 'Just for example', NULL, false, 'Just for example');
...
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect, post_request, name) VALUES ('6265989e-67d2-68ef-9dee-12efe4a4d88d', 'system-action-link-mappings', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'select
    al.title link_title,
...
order by parent_action_name, child_action_name, p.order', NULL, 'SQL', 'Link mapping', NULL, 'Link mapping', NULL, false, 'Link mapping');
...
order by p.action_id, p."order"', NULL, 'SQL', '{extended_parameters.title}', NULL, '{extended_parameters.title}', NULL, false, '{extended_parameters.title}');
...
[
    ...
    $$::jsonb menu', NULL, 'SQL', 'System submenu', NULL, 'System submenu', NULL, false, 'System submenu');
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect, post_request, name) VALUES ('6703218f-54a0-94b7-42b3-ed9e0e4c6685', 'system-set-dictionary', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'DO $$declare
    dictionary_code varchar;
    parameter_id uuid;
    new_link_id uuid;
    link_id uuid;
...
END $$', NULL, 'SQL_BLOCK', 'Set dictionary', NULL, 'Set dictionary', '{request-parameters._original_url}', false, 'Set dictionary');
...
select p."group" value,
       ...
       ''">''|| p."group" ||''</a>'' link
from values p
order by 1', NULL, 'SQL', '{request-parameters.description}', NULL, '{request-parameters.description}', NULL, false, '{request-parameters.description}');
...
order by col.order', NULL, 'SQL', 'Columns for the action "{action_title}"({action_code})', NULL, 'Columns for the action "{action_title}"({action_code})', NULL, false, 'Columns for the action "{action_title}"({action_code})');
...
and (key like :wildcard or :wildcard::varchar is null)', NULL, 'SQL', '{extended-parameters.dictionary_title}', NULL, '{extended-parameters.dictionary_title}', NULL, false, '{extended-parameters.dictionary_title}');
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect, post_request, name) VALUES ('3310ffca-f928-e81b-2a9f-b0bd59d89225', 'system-update-connection', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'update connection set
description = :description,
type = :type,
url = :url,
login = :login,
password = :password,
code = :code
where id = :id', NULL, 'SQL_DML', 'Update connection', NULL, 'Update connection', '{request-parameters._original_url}', false, 'Update connection');
...
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect, post_request, name) VALUES ('4141be2c-75e0-0384-c45f-a619e4fa131c', 'system-create-connection', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'DO $$declare
    id uuid;
    code varchar;
    type varchar;
    url varchar;
...
END $$', NULL, 'SQL_BLOCK', 'Create connection', NULL, 'Create connection', '{request-parameters._original_url}', false, 'Create connection');
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect, post_request, name) VALUES ('9ac0f8b6-01a7-d1f4-2b23-b891bf39012f', 'system-create-action-link', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'insert into action_link values(
    uuid_in(md5(random()::text || random()::text)::cstring),
    ...
    :variable,
    :mapping
)', NULL, 'SQL_DML', 'Create link', NULL, 'Create link', '{request-parameters._original_url}', false, 'Create link');
