...
INSERT INTO public.tmp_property (id, "group", property, value, category_id) VALUES ('d0f767fb-86c3-0a30-d085-b4a932c7e01c', 'action_execution_type', 'SQL', 'SQL', 'f011a155-fa7a-8451-ddf5-d3a360405f19');
...
INSERT INTO public.tmp_property (id, "group", property, value, category_id) VALUES ('613e3a30-baa6-46e4-808b-11f7ff0d747d', 'action_execution_type', 'SQL_BLOCK_WITH_RESULT', 'SQL_BLOCK_WITH_RESULT', 'f011a155-fa7a-8451-ddf5-d3a360405f19');
INSERT INTO public.tmp_property (id, "group", property, value, category_id) VALUES ('7bde51f7-a754-6a81-dec3-adb050cab978', 'system', 'localhost-http-url', 'http://localhost:{properties.system.localhost-port}', '884504a5-53fe-4ace-a6a8-d7d6a9223a88');
