...
INSERT INTO public.tmp_column (id, action_id, name, path, "order") VALUES ('19615b37-2bba-46a7-b637-09eb2565c522', 'dfe67d96-5391-4534-aa8c-a706d985896c', 'Name', 'name', 3);
...
INSERT INTO public.tmp_column (id, action_id, name, path, "order") VALUES ('512a8007-b5a6-b26d-705e-a03e39199a03', 'dfe67d96-5391-4534-aa8c-a706d985896c', 'Data type', 'type', 5);
INSERT INTO public.tmp_column (id, action_id, name, path, "order") VALUES ('6a3206ab-6ee2-218f-aac0-90f62a73ed79', 'dfe67d96-5391-4534-aa8c-a706d985896c', 'Editable', 'editable', 6);
...
INSERT INTO public.tmp_column (id, action_id, name, path, "order") VALUES ('7eb9f52b-f151-f20e-eb10-f627c75e867c', 'dfe67d96-5391-4534-aa8c-a706d985896c', 'Dictionary name', 'dictionary_name', 8);
INSERT INTO public.tmp_column (id, action_id, name, path, "order") VALUES ('d4360d57-93b0-3273-8c2a-bbaab0016de8', 'dfe67d96-5391-4534-aa8c-a706d985896c', 'Title', 'title', 2);
...
INSERT INTO public.tmp_column (id, action_id, name, path, "order") VALUES ('5149579b-3b5b-5a86-b970-80418914b56b', 'dfe67d96-5391-4534-aa8c-a706d985896c', 'Dictionary code', 'dictionary_code', 20);
INSERT INTO public.tmp_column (id, action_id, name, path, "order") VALUES ('8283b156-a692-7ac3-e2b2-a1f45f981116', 'dfe67d96-5391-4534-aa8c-a706d985896c', 'Order', 'order', 30);
INSERT INTO public.tmp_column (id, action_id, name, path, "order") VALUES ('3f1b95b5-022e-9e59-4454-4cf74fba213b', 'dfe67d96-5391-4534-aa8c-a706d985896c', 'Dictionary editable', 'dictionary_editable', 15);
...
INSERT INTO public.tmp_column (id, action_id, name, path, "order") VALUES ('d9fbe207-afdb-7b75-5f91-04fd993ba176', 'dfe67d96-5391-4534-aa8c-a706d985896c', 'Dictionary name column', 'name_column', 9);
INSERT INTO public.tmp_column (id, action_id, name, path, "order") VALUES ('3e5baf28-e9bb-c73f-04df-54475ab242cd', 'dfe67d96-5391-4534-aa8c-a706d985896c', 'Dictionary value column', 'value_column', 10);
...
INSERT INTO public.tmp_column (id, action_id, name, path, "order") VALUES ('182013b6-8286-f306-4794-fbc550df96b2', 'dfe67d96-5391-4534-aa8c-a706d985896c', 'Default value', 'default_value', 7);
