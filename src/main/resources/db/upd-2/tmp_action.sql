...
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect) VALUES ('e6ea59cd-7b58-6a9f-9ddb-01f03de167f2', 'system-delete-property', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'delete from public.property where id = :id', null, 'SQL_DML', 'Delete property', null, 'Delete property', '{_original_url}');
...
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect) VALUES ('95b9eda4-33d1-be18-c667-123b227ee2a1', 'system-set-available-values-view', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', e'insert into dictionary(
        id,
        parameter_id,
        action_id,
        name_column,
...
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect) VALUES ('6e52b5a1-4b58-8992-2e51-1ec289b2dd83', 'system-remove-dictionary', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'delete from dictionary where parameter_id = :parameter_id::uuid', null, 'SQL_DML', 'Remove dictionary', null, 'Remove dictionary', '{_original_url}');
...
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect) VALUES ('8d9f7add-2f20-0e56-7d53-5ea78c2ea052', 'system-properties', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', e'select p.id, p.category_id, p."group", p.property, p.value, pc.code category_code from property p
join property_category pc on p.category_id = pc.id
...
INSERT INTO public.tmp_action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect) VALUES ('fa35b5dd-6e29-6474-3f10-07b684c06a62', 'system-action-links', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', e'with action_mounted as (select l.id,
