...
INSERT INTO public.action (id, code, connection_id, query, content, execution_type, title, post_process, description, redirect) VALUES ('92c2cded-ab53-4472-645c-18af2c19b9dc', 'qqq', 'd48b9a97-e13c-4961-9eff-d76f39abdffb', 'select ''ddd ''||'' - ''||'' ggggg''', null, 'SQL_DQL', 'qqq', null, null, null);
